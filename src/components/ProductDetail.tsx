              ...
              <div className="flex flex-wrap gap-2">
                {bracelets.map((b) => (
                  <button
                    ...
                    className={`group/bracelet relative flex min-w-0 items-center gap-2 rounded-xl border-2 px-4 py-3 text-left transition focus:outline-none focus:ring-2 focus:ring-[var(--logo-gold)] focus:ring-offset-2 ${
                  ...
                  >
                    ...
                    <span className="relative h-8 w-8 shrink-0 overflow-hidden rounded-lg bg-foreground/10">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img src={b.image_url} alt="" className="h-full w-full object-cover" />
                    </span>
                    {/* Hover enlarge preview - outside overflow-hidden so it can show */}
                    <span
                      className="pointer-events-none absolute bottom-full left-1/2 z-20 -translate-x-1/2 overflow-hidden rounded-lg border border-white/20 bg-[var(--logo-green)] shadow-xl opacity-0 transition-opacity duration-200 group-hover/bracelet:opacity-100"
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className="group/addon relative h-16 w-16 shrink-0 overflow-visible rounded-lg bg-foreground/5 ring-2 ring-transparent transition hover:ring-foreground/30 focus:outline-none focus:ring-2 focus:ring-[var(--logo-gold)]"
                        title={isFr ? "Survoler pour agrandir · Cliquer pour plein écran" : "Hover to enlarge · Click for full screen"}
                      >
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img
                        ...
                        <span
                          className="pointer-events-none absolute bottom-full left-1/2 z-20 mb-2 -translate-x-1/2 overflow-hidden rounded-lg border border-white/20 bg-[var(--logo-green)] shadow-xl opacity-0 transition-opacity duration-200 group-hover/addon:opacity-100"
                        ...
                        <span className="absolute inset-0 flex items-center justify-center bg-black/0 transition group-hover/addon:bg-black/30">
                          <svg className="h-6 w-6 text-white opacity-0 drop-shadow-md transition group-hover/addon:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>

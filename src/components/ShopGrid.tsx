    ...
    <div className="grid grid-cols-2 gap-3 sm:gap-5 md:grid-cols-3 md:gap-8">
      {watches.map((watch, index) => (
        ...
        >
          ...
          >
            <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-white sm:rounded-[18px] md:rounded-[22px]">
              ...
              <Image
                ...
                alt={watch.name}
                fill
                className={`scale-[0.94] object-cover transition-opacity duration-300 ${loadedImages[watch.id] ? "opacity-100" : "opacity-0"}`}

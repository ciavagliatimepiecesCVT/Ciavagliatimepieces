...
const nextConfig: NextConfig = {
  experimental: {
    serverActions: {
      // Large limit so admin can upload short MP4/WebM/MOV clips (journal / about); images stay 5MB in app logic.
      bodySizeLimit: "100mb",
    },
  },
  images: {
  ...
  async headers() {
    const cspDirectives = [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://js.stripe.com https://www.spaxioassistant.com https://www.facebook.com https://graph.facebook.com",
